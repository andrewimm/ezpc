...
pub static DISPATCH_TABLE: [InstructionHandler; 256] = [
    ...
    invalid_opcode, // 0x32: XOR r8, r/m8 (not implemented yet)
    invalid_opcode, // 0x33: XOR r16, r/m16 (not implemented yet)
    invalid_opcode, // 0x34: XOR AL, imm8 (not implemented yet)
    invalid_opcode, // 0x35: XOR AX, imm16 (not implemented yet)
    ...
    invalid_opcode, // 0xF9: STC (not implemented yet)
    invalid_opcode, // 0xFA: CLI (not implemented yet)
    invalid_opcode, // 0xFB: STI (not implemented yet)
